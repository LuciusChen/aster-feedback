...
iOS/iPadOS 当前文档基线为 0.1 (18)（2026-09-15）。已确认上传 App Store Connect；最后记录为 TestFlight 处理中，尚未独立确认可下载状态。Android 文档基线仍为 0.1 (9)，正在准备 Google Play 测试，尚未公开发布。
...
这些概览截图沿用此前版本，并非 build 12 的逐项验收截图。新增的文件排序、同步摘要、标题链接和 Focus 操作以对应指南为准。
