...
The iOS/iPadOS documentation uses 0.1 (15), dated 10 September 2026, as its baseline. The build has been uploaded to App Store Connect and is awaiting TestFlight processing. Android documentation remains at 0.1 (9); its build is being prepared for Google Play testing and is not publicly available yet.
...
These overview images remain from an earlier build, not a build 12 acceptance run. See the corresponding guides for the new file sorting, sync summaries, heading links, and Focus controls.
