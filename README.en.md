...
The iOS/iPadOS documentation uses release candidate 0.1 (16), dated 12 September 2026, as its baseline; TestFlight upload is pending. Android documentation remains at 0.1 (9); its build is being prepared for Google Play testing and is not publicly available yet.
