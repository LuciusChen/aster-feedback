...
The iOS/iPadOS documentation uses 0.1 (14), dated 8 September 2026, as its baseline. The TestFlight upload is being prepared. Android documentation remains at 0.1 (9); its build is being prepared for Google Play testing and is not publicly available yet.
